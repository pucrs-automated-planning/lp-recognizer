...
class LPRecognizerDeltaHS(LPRecognizerHValue):
    ...
    def run_recognizer(self):
        ...
        min_diff = float("inf")
        # Select unique goal
        for i, hc, hs in  zip(range(len(self.constraints_recognizer.hyps)), self.constraints_recognizer.hyps, self.hsoft_recognizer.hyps):
        ...
        for i, hs, hc in  zip(range(len(self.constraints_recognizer.hyps)), self.hsoft_recognizer.hyps, self.constraints_recognizer.hyps):
            if not hs.test_failed and not hc.test_failed:
