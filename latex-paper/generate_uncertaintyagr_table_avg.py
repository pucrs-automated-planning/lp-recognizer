...
def get_latex_content(file, domains):
	...
	approaches = ['delta-h-c', 'delta-h-c-uncertainty', 'rg2009', 'lm_hc0', 'lm_hc10', 'lm_hc30']
	...
	def print_agreements(domain_data, approaches):
		...
		for approach in approaches:
			...
			if ar == best_ar:
				ar = "\\textbf{%s}" % ar
			content_line += ' & ' + str(ar) + ' & ' + str(acc) + ' & ' + str(spr)
		return content_line
...
if __name__ == '__main__' :
	...
	file = 'uncertaintyagr-avg.tex'
	template = 'uncertaintyagr-template.tex'
