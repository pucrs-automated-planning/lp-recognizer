...
def get_latex_content(file, domains):
	...
	content_table = ''
	def print_agreements(domain_data, best_source, approaches):
		content_line = ''
		# Find best
		best_ar = 0
	...
	for domain_name in domains:
		...
		content_table += ' & '
		content_table += print_agreements(all_domain_data[domain_name + '-optimal'], singles, singles)
		content_table += print_agreements(all_domain_data[domain_name + '-optimal'], pairs, pairs)
		content_table += print_agreements(all_domain_data[domain_name + '-optimal'], singles + pairs + triples, triples)
		content_table += print_agreements(all_domain_data[domain_name + '-suboptimal'], singles, singles)
		content_table += print_agreements(all_domain_data[domain_name + '-suboptimal'], pairs, pairs)
		content_table += print_agreements(all_domain_data[domain_name + '-suboptimal'], singles + pairs + triples, triples)
		content_table += "\\\\"
		content_table += '\hline\n'
