...
class LPRecognizerHValue(PlanRecognizer):
    ...
    def __init__(self, options, constraints = False, soft_constraints = False, delta = False, auto_uncertainty = False):
        PlanRecognizer.__init__(self, options, constraints, soft_constraints, delta, auto_uncertainty)
